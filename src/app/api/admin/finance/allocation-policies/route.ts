...
import { createAllocationPolicy, getManagementConfiguration } from "@/features/finance";
...
export async function GET(request: Request) {
  ...
  return NextResponse.json((await getManagementConfiguration(period)).policies);
}

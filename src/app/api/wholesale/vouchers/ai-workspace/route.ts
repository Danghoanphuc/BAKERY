...
import { defaultVoucherDraft, type VoucherDraft } from "@/app/wholesale/vouchers/_lib/voucher-admin";
import { normalizeVoucherDraft } from "@/features/wholesale-admin/vouchers/ai/voucher-ai-service";
import { loadVoucherAiWorkspace } from "@/features/wholesale-admin/vouchers/ai/voucher-ai-repository";
import { simulateVoucherScenarios, type VoucherBusinessSnapshot } from "@/features/wholesale-admin/vouchers/ai/voucher-business-context";

...
export default function AdminVoucherScanPage() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <Link href="/wholesale/pos" className="mb-3 inline-flex items-center gap-2 text-sm font-bold text-neutral-500 hover:text-neutral-950"><ArrowLeft className="h-4 w-4" /> Quay lại POS</Link>
